/****************************************************************************************
 Extension Name: EXT101MI/UpdLine
...
public class UpdLine extends ExtendM3Transaction {
	...
	/*
	 * Transaction EXT101MI/UpdLine Interface
	...
	public void main() {
		...
		DBAction fgdibdRecord = database.table("FGDIBD").index("00").selection("BYCHNO").build()
		...
		boolean updatable = fgdibdRecord.readLock(fgdibdContainer, { LockedResult updateRecoord ->

			updateRecoord.setString("BYTX40", tx40)
			updateRecoord.setString("BYBFA1", bfa1)
			updateRecoord.setString("BYBFA2", bfa2)
			updateRecoord.setString("BYBFA3", bfa3)
			updateRecoord.setString("BYBFA4", bfa4)
			updateRecoord.setString("BYBFA5", bfa5)
			updateRecoord.setString("BYBFA6", bfa6)
			updateRecoord.setString("BYBFA7", bfa7)
			updateRecoord.setString("BYBTA1", bta1)
			updateRecoord.setString("BYBTA2", bta2)
			updateRecoord.setString("BYBTA3", bta3)
			updateRecoord.setString("BYBTA4", bta4)
			updateRecoord.setString("BYBTA5", bta5)
			updateRecoord.setString("BYBTA6", bta6)
			updateRecoord.setString("BYBTA7", bta7)
			updateRecoord.setString("BYOBF1", obf1)
			updateRecoord.setString("BYOBF2", obf2)
			updateRecoord.setString("BYOBF3", obf3)
			updateRecoord.setString("BYOBT1", obt1)
			updateRecoord.setString("BYOBT2", obt2)
