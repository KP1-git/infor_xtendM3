...
public class UpdLine extends ExtendM3Transaction {
	...
	public void main() {
		...
		boolean updatable = fgdisdRecord.readLock(fgdibdContainer, { LockedResult updateRecord ->
			updateRecord.setString("BGTX40", tx40)
			updateRecord.setString("BGSFA1", sfa1)
			updateRecord.setString("BGSFA2", sfa2)
			updateRecord.setString("BGSFA3", sfa3)
			updateRecord.setString("BGSFA4", sfa4)
			updateRecord.setString("BGSFA5", sfa5)
			updateRecord.setString("BGSFA6", sfa6)
			updateRecord.setString("BGSFA7", sfa7)
			updateRecord.setString("BGSTA1", xxsta1)
			updateRecord.setString("BGSTA2", xxsta2)
			updateRecord.setString("BGSTA3", xxsta3)
			updateRecord.setString("BGSTA4", xxsta4)
			updateRecord.setString("BGSTA5", xxsta5)
			updateRecord.setString("BGSTA6", xxsta6)
			updateRecord.setString("BGSTA7", xxsta7)
			updateRecord.setString("BGOBF1", obf1)
			updateRecord.setString("BGOBF2", obf2)
			updateRecord.setString("BGOBF3", obf3)
			updateRecord.setString("BGOBT1", obt1)
