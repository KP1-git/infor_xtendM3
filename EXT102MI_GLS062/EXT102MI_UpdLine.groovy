 ...
 * Update a record in FGDITD
 ...
 d.decosterd@hetic3.fr   2026-03-10       1.1               Use lowerCamelCase for variable CHNO, remove unused method isValidTfa1, declare only one instance of errorMessage variable by function
 ******************************************************************************************/
